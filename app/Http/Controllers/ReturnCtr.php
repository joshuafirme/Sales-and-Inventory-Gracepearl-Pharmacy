...
class ReturnCtr extends Controller
{
    ...
    public function getReturns(){
        ...
        ->select($this->tbl_return.".*", DB::raw('CONCAT('.date('y-d').', '.$this->tbl_return.'.id) AS returnID, DATE_FORMAT(date,"%d/%m/%Y") as date, description, unit, supplierName, category_name'))
