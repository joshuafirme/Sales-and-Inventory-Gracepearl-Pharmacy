      ...
      <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{ url('/account/change-email') }}" class="label-small" style="color: #1F6EA6;">Update</a>
                </div>
    
                <div class="col-md-4">
                    <label class="label-small">Phone Number</label>
                    <input type="number" class="form-control" id="phone_no" readonly>
                    <a href="{{ url('/account/change-contact') }}" class="label-small" style="color: #1F6EA6;">Update</a>
                </div> 
