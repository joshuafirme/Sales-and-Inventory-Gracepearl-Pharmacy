  ...
  <h3 class="mt-2" id="page-title">Product Maintenance</h3>
        ...
        <div class="row">
          ...
          <div class="col-sm-6  col-lg-12 mb-3">
            ...
            <a class="btn btn-success btn-sm" href="#" target="_blank" ><span class='fa fa-file-excel'></span> Import Excel</a> 
            <a class="btn btn-danger btn-sm" id="btn-pdf" href="#"  ><span class='fa fa-file-pdf'></span> Print as PDF</a> 
            </div>
          ...
          <div class="col-md-12 col-lg-12">
            <div class="box box-primary">
              ...
              <div class="container-fluid">
                ...
                <div class="input-group col-sm-3 col-md-3 mt-4 mb-3">              
