...
<main class="m-auto">
    ...
    <div class="col-lg-8 m-auto"><h4 class="mt-2 mb-2">Change Phone Number</h4></div>
          ...
          <div class="card-body card-cart">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <p class="mb-0">We will send you a one time code to your email or phone number to update your phone number.</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="label-small">New phone number</label>
                            <input type="number" class="form-control" id="new-contact">
                        </div>            
                        ...
                        <div class="col-md-3 mt-1">
                            <button id="btn-update-contact" class="btn btn-sm btn-primary">Update</button>
                        </div>
            ...
            <div class="alert alert-success alert-dismissible mt-3" style="display: none;" id="change-pass-success">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <h5><i class="icon fas fa-check"></i> </h5>
              <p>Your phone number is updated successfully</p>
            </div>
