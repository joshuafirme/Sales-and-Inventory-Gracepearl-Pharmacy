...
Route::post('/manageorder/do-pack/{order_no}', 'ManageOnlineOrderCtr@packItems');
Route::post('/manageorder/do-dispatch/{order_no}', 'ManageOnlineOrderCtr@dispatchItems');
Route::post('/manageorder/do-delivered/{order_no}', 'ManageOnlineOrderCtr@deliveredItems');
